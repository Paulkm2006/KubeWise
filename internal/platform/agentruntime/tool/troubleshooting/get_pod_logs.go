...
func (t *GetPodLogsTool) Meta() toolv2.ToolMeta {
...
// Execute 执行工具调用
func (t *GetPodLogsTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *GetPodLogsTool) executeText(ctx context.Context, args map[string]any) (string, error) {
