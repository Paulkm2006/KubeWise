...
func NewAuditImageSecurityTool(k8sClient *cluster.Client) *AuditImageSecurityTool {
...
func (t *AuditImageSecurityTool) Meta() toolv2.ToolMeta {
...
// Execute 执行工具调用
func (t *AuditImageSecurityTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *AuditImageSecurityTool) executeText(ctx context.Context, args map[string]any) (string, error) {
