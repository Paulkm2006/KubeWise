...
func (t *LabelAnnotateResourceTool) Meta() toolv2.ToolMeta {
	return operationWriteMeta(t.Name(), t.Description(), t.Parameters())
}

func (t *LabelAnnotateResourceTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
// executeText applies the given labels and/or annotations to the target resource.
func (t *LabelAnnotateResourceTool) executeText(ctx context.Context, args map[string]any) (string, error) {
