...
func (t *GetPodResourceUsageTool) Meta() toolv2.ToolMeta {
...
func (t *GetPodResourceUsageTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *GetPodResourceUsageTool) executeText(ctx context.Context, args map[string]any) (string, error) {
