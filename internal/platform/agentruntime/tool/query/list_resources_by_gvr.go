...
func NewListResourcesByGvrTool(k8sClient *cluster.Client) *ListResourcesByGvrTool {
...
func (t *ListResourcesByGvrTool) Meta() toolv2.ToolMeta {
...
func (t *ListResourcesByGvrTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *ListResourcesByGvrTool) executeText(ctx context.Context, args map[string]any) (string, error) {
