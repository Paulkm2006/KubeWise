...
func (t *GetPodDetailTool) Meta() toolv2.ToolMeta {
...
func (t *GetPodDetailTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *GetPodDetailTool) executeText(ctx context.Context, args map[string]any) (string, error) {
