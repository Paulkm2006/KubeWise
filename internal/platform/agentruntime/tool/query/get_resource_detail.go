...
func (t *GetResourceDetailTool) Meta() toolv2.ToolMeta {
...
func (t *GetResourceDetailTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *GetResourceDetailTool) executeText(ctx context.Context, args map[string]any) (string, error) {
