...
func (t *FindPodsUsingPVCTool) Description() string {
	return "查找使用指定PVC的所有Pod，不指定命名空间则在所有命名空间中查找"
}
...
func (t *FindPodsUsingPVCTool) Meta() toolv2.ToolMeta {
...
func (t *FindPodsUsingPVCTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *FindPodsUsingPVCTool) executeText(ctx context.Context, args map[string]any) (string, error) {
