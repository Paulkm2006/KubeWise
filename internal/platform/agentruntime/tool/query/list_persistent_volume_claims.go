...
func NewListPersistentVolumeClaimsTool(k8sClient *cluster.Client) *ListPersistentVolumeClaimsTool {
...
func (t *ListPersistentVolumeClaimsTool) Meta() toolv2.ToolMeta {
...
func (t *ListPersistentVolumeClaimsTool) Execute(ctx context.Context, args map[string]any) (toolv2.ToolResult, error) {
	meta := t.Meta()
...
func (t *ListPersistentVolumeClaimsTool) executeText(ctx context.Context, args map[string]any) (string, error) {
	namespace := ""
