...
func (m *SidebarModel) SetSessions(sessions []*domain.Conversation) {
	m.sessions = sessions
	m.selected = 0
}
...
// SelectedIndex returns the index of the currently highlighted domain.
...
func (m SidebarModel) SelectedSession() *domain.Conversation {
